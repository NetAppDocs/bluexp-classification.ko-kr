...
* 사내 ONTAP 시스템의 경우, https://["BlueXP는 ONTAP 클러스터를 검색해야 합니다"^]
...
Cloud Volumes ONTAP 시스템은 BlueXP의 Canvas에서 이미 사용 가능해야 합니다. 사내 ONTAP 시스템의 경우 가 있어야 합니다 https://["BlueXP는 이러한 클러스터를 검색합니다"^].
