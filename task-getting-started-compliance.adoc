...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["1개"] 검사할 데이터 원본을 검색합니다
[role="quick-margin-para"]
볼륨을 스캔하려면 먼저 시스템을 BlueXP의 작업 환경으로 추가해야 합니다.

[role="quick-margin-list"]
* Cloud Volumes ONTAP 시스템의 경우 BlueXP에서 이러한 작업 환경을 사용할 수 있어야 합니다
* 온프레미스 ONTAP 시스템의 경우 https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["BlueXP는 ONTAP 클러스터를 검색해야 합니다"^]
...
Cloud Volumes ONTAP 시스템은 BlueXP의 Canvas에서 이미 사용 가능해야 합니다. 온프레미스 ONTAP 시스템의 경우 가 https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["BlueXP는 이러한 클러스터를 검색합니다"^]필요합니다.
