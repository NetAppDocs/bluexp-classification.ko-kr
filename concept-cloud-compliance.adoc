...
이름 요소 인식:: BlueXP 분류에서는 AI를 사용하여 문서에서 사람들의 자연어 이름을 추출합니다. link:task-generating-compliance-reports.html#what-is-a-data-subject-access-request["데이터 주체 액세스 요청에 응답하는 방법에 대해 알아봅니다"^].
