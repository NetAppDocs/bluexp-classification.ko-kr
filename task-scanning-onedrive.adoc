...
참고: 이 작업은 수행할 수 있습니다 link:task-managing-compliance.html#removing-a-onedrive-sharepoint-or-google-drive-account-from-bluexp-classification["BlueXP 분류에서 전체 OneDrive 계정을 삭제합니다"] 더 이상 OneDrive 계정에서 사용자 데이터를 스캔하지 않으려는 경우
