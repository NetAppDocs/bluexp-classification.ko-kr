...
+
https://["Linux 인스턴스용 AWS 보안 그룹"^]

+
https://["Windows 인스턴스용 AWS 보안 그룹"^]

+
https://["AWS의 탄력적인 네트워크 인터페이스(ENI)"^]
...
ONTAP 볼륨에 대해 FSx를 스캔하기 전에 https://["볼륨이 구성된 FSx 작업 환경이 있어야 합니다"^].
...
https://["BlueXP에서 ONTAP 파일 시스템용 FSx를 검색 또는 생성하는 방법을 확인하십시오"^].
