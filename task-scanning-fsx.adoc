...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["1개"] 검사할 FSx for ONTAP 파일 시스템을 검색합니다
[role="quick-margin-para"]
FSx for ONTAP 볼륨을 스캔하기 전에 https://docs.netapp.com/us-en/bluexp-fsx-ontap/start/concept-fsx-aws.html["볼륨이 구성된 FSx 작업 환경이 있어야 합니다"^],
...
+
자세한 내용은 볼륨에 대한 규정 준수 검사 활성화 및 비활성화 를 참조하십시오.
