...
https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-creating-fsx-working-environment.html["BlueXP에서 ONTAP 파일 시스템용 FSx를 검색 또는 생성하는 방법을 확인하십시오"^].
...
NOTE: ONTAP용 FSx의 경우 클라우드 데이터 센스에서 BlueXP와 동일한 영역에서만 볼륨을 스캔할 수 있습니다.
