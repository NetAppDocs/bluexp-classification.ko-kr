...
summary: 웹 UI를 통해 제공되는 BlueXP classification 기능은 REST API를 통해서도 사용할 수 있습니다. 
---
= BlueXP 분류 API
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
웹 UI를 통해 제공되는 BlueXP classification 기능은 REST API를 통해서도 사용할 수 있습니다.
...
API 참조에 액세스하려면 BlueXP classification 인스턴스의 IP 주소가 필요합니다.  클라우드에 배포한 경우 공개 ID 주소를 사용하세요. 예를 들어:
