...
또한 가능합니다link:task-deploy-compliance-onprem.html["인터넷에 액세스할 수 있는 사내 사이트에 BlueXP 분류를 배포합니다"].
...
| * 초대형 * | 32개의 CPU | 128GB RAM | /opt-895GiB에서 1TiB SSD를 사용하거나 -100GiB를 /var/lib/docker에서 사용할 수 있음 - /tmp에서 5GiB 사용 가능 


| * 대형 * | 16개의 CPU | 64GB RAM | /opt-395GiB에서 /var/lib/docker 또는 Podman/var/lib/컨테이너 또는 Podman/var/lib/containers - /tmp에서 500GiB SSD를 사용하거나 -100GiB에서 사용 가능 
|===
