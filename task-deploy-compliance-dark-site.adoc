...
또한 가능합니다 link:task-licensing-datasense.html["BlueXP 분류에 대한 BYOL 라이센스 설정"] 현재 BlueXP 디지털 전자지갑에서 30일 무료 평가판이 종료될 때까지 요금이 부과되지 않습니다.
...
.시작하기 전에
* BlueXP Connector 소프트웨어를 최신 버전으로 업그레이드하는 것이 좋습니다. https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-connectors.html["커넥터 업그레이드 단계를 참조하십시오"^].
