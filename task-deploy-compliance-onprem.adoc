...
summary: 몇 가지 단계를 완료하여 네트워크의 Linux 호스트 또는 인터넷 액세스가 가능한 클라우드의 Linux 호스트에 Cloud Data Sense를 배포합니다. 
---
= 인터넷에 액세스할 수 있는 호스트에 클라우드 데이터 센스를 배포합니다
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
몇 가지 단계를 완료하여 네트워크의 Linux 호스트 또는 인터넷 액세스가 가능한 클라우드의 Linux 호스트에 Cloud Data Sense를 배포합니다.
...
. 클라우드의 인스턴스에 배포할지 아니면 온프레미스의 인스턴스에 구축하는지에 따라 적절한 * 배포 * 버튼을 클릭하여 데이터 감지 구축 마법사를 시작합니다.
+
