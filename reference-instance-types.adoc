...
| 대형 | CPU 16개, 64GB RAM, 500GiB SSD | https://["m6i.4xLarge"^] (기본값) m6a.4xLarge m5a.4xLarge m5.4xLarge m4.4xLarge 


| 중간 | CPU 8개, 32GB RAM, 200GiB SSD | https://["m6i.2xLarge"^] (기본값) m6a.2xLarge m5a.2xLarge m5.2xLarge m4.2xLarge 


| 작은 크기 | CPU 8개, 16GB RAM, 100GiB SSD | https://["c6a.2xLarge"^] (기본값) C5A.2xLarge c5.2xLarge c4.2xLarge 
|===
...
| 대형 | CPU 16개, 64GB RAM, 500GiB SSD | https://["standard_d16s_v3"^] (기본값) 
|===
...
| 대형 | CPU 16개, 64GB RAM, 500GiB SSD | https://["N2-표준-16"^] (기본값) n2d-standard-16 n1-standard-16 
|===